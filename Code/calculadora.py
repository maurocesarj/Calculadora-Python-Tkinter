...
btnponto = Button(app, text='.', bg="lightblue", pady=13, padx=42, bd=3)
...
#Quarta fileira:
btnsoma = Button(app, text='+', bg="lightblue", pady=14, padx=14, bd=3)
btnsoma.place(x=160, y=100)

btnsub = Button(app, text='-', bg="lightblue", pady=14, padx=14, bd=3)
btnsub.place(x=160, y=155)

btnmult = Button(app, text='x', bg="lightblue", pady=14, padx=14, bd=3)
btnmult.place(x=160, y=210)

btndiv = Button(app, text='/', bg="lightblue", pady=14, padx=14, bd=3)
btndiv.place(x=160, y=265)


#botao do CE
btnce = Button(app, text='CE', bg="lightblue", pady=95.5, padx=14, bd=3)
btnce.place(x=210, y=100)

#botao do =
btnigual = Button(app, text='=', bg="lightblue", pady=14, padx=119, bd=3)
